from selection.selectionCondition.EPS_GROWTH_RATE import *
import unittest
from testCase.selection.selectionCondition import *


class EPS_GROWTH_RATE_TEST(unittest.TestCase):

    def setUp(self):
        self.start_date = '2020-11-06'  # 开始日期

        self.end_date = '2020-11-06'  # 结束日期

        self.env = 'dev'  # 环境

        self.condition = 'EPS_GROWTH_RATE:SD,>=,-9TD'  # 条件
        # self.condition = 'EPS_GROWTH_RATE:SD,>=,3'  # 条件
        ...
        self.ob = EPS_GROWTH_RATE(self.para_list, self.start_date, self.end_date, self.env)
