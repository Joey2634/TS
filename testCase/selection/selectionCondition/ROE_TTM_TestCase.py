from selection.selectionCondition.ROE_TTM import *
import unittest
from testCase.selection.selectionCondition import *


class ROE_TTM_TEST(unittest.TestCase):
    def setUp(self):
        ...
        self.condition = 'ROE_TTM:SD,>=,20'  # 条件
        # self.condition = 'ROE_TTM:-1Y,>=,20'  # 条件
        # self.condition = 'ROE_TTM:-2Y,>=,20'  # 条件
        ...
        self.ob = ROE_TTM(self.para_list, self.start_date, self.end_date, self.env)
