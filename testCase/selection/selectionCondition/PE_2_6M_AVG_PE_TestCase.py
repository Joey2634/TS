from selection.selectionCondition.PE_2_6M_AVG_PE import *
import unittest
from testCase.selection.selectionCondition import *


class PE_2_6M_AVG_PE_TEST(unittest.TestCase):
    def setUp(self):
        ...
        self.condition = 'PE_2_6M_AVG_PE:-1TD,<=,1.1'  # 条件
        ...
        self.ob = PE_2_6M_AVG_PE(self.para_list, self.start_date, self.end_date, self.env)
