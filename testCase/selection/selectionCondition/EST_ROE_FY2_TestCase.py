from selection.selectionCondition.EST_ROE_FY2 import *
import unittest
from testCase.selection.selectionCondition import *


class EST_ROE_FY2_TEST(unittest.TestCase):
    def setUp(self):
        ...
        self.condition = 'EST_ROE_FY2:SD,>=,20'  # 条件
        ...
        self.ob = EST_ROE_FY2(self.para_list, self.start_date, self.end_date, self.env)
