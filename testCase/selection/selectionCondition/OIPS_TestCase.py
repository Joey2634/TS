from selection.selectionCondition.OIPS import *
import unittest
from testCase.selection.selectionCondition import *


class OIPS_TEST(unittest.TestCase):
    def setUp(self):
        ...
        self.condition = 'OIPS:SD,>=,-12TD'  # 条件
        ...
        self.ob = OIPS(self.para_list, self.start_date, self.end_date, self.env)
