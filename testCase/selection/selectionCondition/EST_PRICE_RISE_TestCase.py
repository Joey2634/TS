from selection.selectionCondition.EST_PRICE_RISE import *
import unittest
from testCase.selection.selectionCondition import *


class EST_PRICE_RISE_TEST(unittest.TestCase):
    def setUp(self):
        ...
        self.condition = 'EST_PRICE_RISE:-1TD,>=,5'  # 条件
        ...
        self.ob = EST_PRICE_RISE(self.para_list, self.start_date, self.end_date, self.env)
